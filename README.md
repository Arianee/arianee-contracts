...
Working with on arbitrum L3 (on arbitrum gas calculation is broken, you need to add : --skip-simulation): 
```shell
npm run script <chainId> DeployBaseScript -- --broadcast  --skip-simulation
```
